...
def mylsq_fast(teta, nonorm_initial, dFnorm_initial, G, dcurrent_initial, dFmax, do, nref_initial, dFref_initial, imax,
               x, y, data):
    amax, B, gama = teta
    ...
    sol = solve_ivp(
        aggregationdF, t_span, Yo, method='BDF', t_eval=t_eval,
    ...
    for i in range(len(t_eval)):
        no_i = Y_result[i, :imax] * nref_initial
        dFo_i = Y_result[i, imax] * dFref_initial
